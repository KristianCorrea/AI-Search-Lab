...
const labs = [
  {
    ...
    description:
      "Compare BFS, Dijkstra, and A* on an N-puzzle with custom image tiles.",
    icon: Grid3x3,
    accent: "violet",
  },
  {
    ...
    description:
      "Pit Minimax against Alpha-Beta pruning and measure search performance.",
    icon: Brain,
    accent: "emerald",
  },
] as const;
    ...
    <div className="space-y-8">
      <section className="space-y-3">
        ...
        <p className="max-w-2xl text-neutral-600 dark:text-neutral-400">
          Interactive experiments for uninformed and informed search, plus
          adversarial game-tree algorithms. Metrics and benchmarks help compare
          efficiency across approaches.
        </p>
      </section>
